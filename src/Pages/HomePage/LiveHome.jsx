...
//                 {activeRole ? `Login as ${activeRole}` : 'Login as'}
//               </h3>
...
//                     className="flex flex-col items-center p-6 rounded-lg border-2 border-gray-200 hover:border-indigo-300 transition-all"
//                   >
//                     <div className="bg-indigo-100 p-4 rounded-full mb-3">
//                       <FiUser className="h-6 w-6 text-indigo-600" />
//                     </div>
//                     <h4 className="font-medium text-gray-900">Reader</h4>
//                     <p className="text-sm text-gray-500 mt-1">Access books & reading lists</p>
//                   </button>
...
//                     <p className="text-sm text-gray-500 mt-1">Publish & manage your books</p>
//                   </button>
                  
//                   {/* Super Admin */}
//                   {/* <button
//                     onClick={() => setActiveRole('Super Admin')}
//                     className=" hidden flex flex-col items-center p-6 rounded-lg border-2 border-gray-200 hover:border-indigo-300 transition-all"
//                   >
//                     <div className="bg-indigo-100 p-4 rounded-full mb-3">
...
//                     {activeRole === 'Author' && (
//                       <div>
//                         <label htmlFor="author-code" className="block text-sm font-medium text-gray-700">
//                           Author Code (Optional)
//                         </label>
//                         <div className="mt-1">
//                           <input
//                             id="author-code"
